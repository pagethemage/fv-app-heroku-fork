# Generated by Django 4.2.16 on 2024-11-02 01:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appointment_time', models.TimeField(default='00:00:00', null=True)),
                ('status', models.CharField(choices=[('upcoming', 'Upcoming'), ('ongoing', 'Ongoing'), ('complete', 'Complete'), ('cancelled', 'Cancelled')], default='upcoming', max_length=10)),
                ('match', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='appointment_management.match')),
                ('referee', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='appointment_management.referee')),
